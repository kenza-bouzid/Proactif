...
public class Service {
    ...
    public static void initialisationEmploye() throws ParseException {
        ...
        try {
            JpaUtil.creerEntityManager();
            JpaUtil.ouvrirTransaction();
            Employe e = new Employe("08:00:00", "18:00:00", "Mr", "Jeanne", "Julien", "1996-09-25", "5 Impasse Bayet, Villeurbanne", "0689743698", "emp1@gmail.com", "123");
            e.setCoord(GeoTest.getLatLng(e.getAdresse()));
            EmployeDao.persist(e);
            Employe e1 = new Employe("10:00:00", "14:00:00", "Mr", "Jeanne", "Bob", "1994-10-15", "14 Rue du Luizet, Villeurbanne", "0669892316", "emp2@gmail.com", "123");
            e1.setCoord(GeoTest.getLatLng(e1.getAdresse()));
            EmployeDao.persist(e1);
            Employe e2 = new Employe("08:00:00", "23:45:00", "Mr", "Loic", "Laura", "1992-04-02", "9 Rue Burais, Villeurbanne", "0689746315", "emp3@gmail.com", "123");
            ...
            Employe e6 = new Employe("08:00:00", "02:00:00", "Mr", "Lelouard", "Pierre", "1997-09-03", "19 Avenue Paul Kruger, Villeurbanne", "07956314289", "emp7@gmail.com", "123");
            e6.setCoord(GeoTest.getLatLng(e6.getAdresse()));
            EmployeDao.persist(e6);
            Employe e7 = new Employe("10:00:00", "23:59:00", "Mr", "Hamidovic", "Martin", "1994-07-01", "15 Place de Croix Luizet, Villeurbanne", "06479515697", "emp8@gmail.com", "123");
