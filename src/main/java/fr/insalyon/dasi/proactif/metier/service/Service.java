 ...
 */
    public static void initialisationEmploye() throws ParseException {
        ...
        try {
            JpaUtil.creerEntityManager();
            JpaUtil.ouvrirTransaction();
            Employe e = new Employe("08:00:00", "18:00:00", "Mr", "Jeanne", "Julien", "1996-09-25", "7 Avenue Jean Capelle Ouest, Villeurbanne", "0689743698", "emp1@gmail.com", "123");
            e.setCoord(GeoTest.getLatLng(e.getAdresse()));
            EmployeDao.persist(e);
            Employe e1 = new Employe("10:00:00", "14:00:00", "Mr", "Jeanne", "Bob", "1994-10-15", "37 Avenue Jean Capelle Est, Villeurbanne", "0669892316", "emp2@gmail.com", "123");
            e1.setCoord(GeoTest.getLatLng(e1.getAdresse()));
            EmployeDao.persist(e1);
            Employe e2 = new Employe("08:00:00", "23:45:00", "Mr", "Loic", "Laura", "1992-04-02", "61 Avenue Roger Salengro, Villeurbanne", "0689746315", "emp3@gmail.com", "123");
            e2.setCoord(GeoTest.getLatLng(e2.getAdresse()));
            EmployeDao.persist(e2);
            Employe e3 = new Employe("06:00:00", "23:59:00", "Mme", "Cavagna", "Lea", "1994-10-14", "15 Avenue Roger Salengro, Villeurbanne", "0634897512", "emp4@gmail.com", "123");
            e3.setCoord(GeoTest.getLatLng(e3.getAdresse()));
            EmployeDao.persist(e3);
            Employe e4 = new Employe("11:00:00", "23:59:00", "Mme", "Paquet", "Louise", "1998-04-01", "20 Avenue Albert Einstein, Villeurbanne", "03987463158", "emp5@gmail.com", "123");
            e4.setCoord(GeoTest.getLatLng(e4.getAdresse()));
            EmployeDao.persist(e4);
            Employe e5 = new Employe("16:30:00", "23:59:00", "Mr", "Genest", "Marc", "1998-06-03", "37 Avenue Jean Capelle Est, Villeurbanne", "03698745216", "emp6@gmail.com", "123");
            e5.setCoord(GeoTest.getLatLng(e5.getAdresse()));
            EmployeDao.persist(e5);
            Employe e6 = new Employe("08:00:00", "02:00:00", "Mr", "Lelouard", "Pierre", "1997-09-03", "20 Avenue Jean Capelle Ouest, Villeurbanne", "07956314289", "emp7@gmail.com", "123");
            e6.setCoord(GeoTest.getLatLng(e6.getAdresse()));
            EmployeDao.persist(e6);
            Employe e7 = new Employe("10:00:00", "23:59:00", "Mr", "Hamidovic", "Martin", "1994-07-01", "7 Avenue Jean Capelle Est, Villeurbanne", "06479515697", "emp8@gmail.com", "123");
            e7.setCoord(GeoTest.getLatLng(e7.getAdresse()));
            EmployeDao.persist(e7);
            Employe e8 = new Employe("16:00:00", "23:59:00", "Mr", "Scotto", "David", "1970-04-27", "21 Avenue Albert Einstein, Villeurbanne", "02698756325", "emp9@gmail.com", "123");
            e8.setCoord(GeoTest.getLatLng(e8.getAdresse()));
            EmployeDao.persist(e8);
            Employe e9 = new Employe("12:00:00", "23:00:00", "Mr", "Tandereau", "Nathan", "1964-05-07", "69 Avenue Roger Salengro, Villeurbanne", "06479951463", "emp10@gmail.com", "123");
 ...
 */    
    public static void initialisationClient() throws ParseException {
        try {
            JpaUtil.creerEntityManager();
            JpaUtil.ouvrirTransaction();
            Client c = new Client("Mr", "Jeanne", "Patrick", "1996-09-25", "15 Avenue Jean Capelle Ouest, Villeurbanne", "0689743698", "cli1@gmail.com", "123");
            c.setCoord(GeoTest.getLatLng(c.getAdresse()));
            ClientDao.persist(c);
            ...
            c.setCoord(GeoTest.getLatLng(c.getAdresse()));
            ClientDao.persist(c);
            c = new Client("Mme", "Cavagna", "Lea", "1993-10-14", "21 Avenue Jean Capelle Ouest, Villeurbanne", "0634897512", "cli4@gmail.com", "123");
            c.setCoord(GeoTest.getLatLng(c.getAdresse()));
            ClientDao.persist(c);
